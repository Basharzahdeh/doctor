...
class _AddQuestionState extends State<AddQuestion> {
  ...
  void initState() {
    super.initState();
    _optionsControllers.add(TextEditingController()); // Initial option text field
  }
                ...
                child: ElevatedButton(
                  onPressed: () {
                    Navigator.of(context).pop(getData1.addItem(
                      ...
                      _optionsControllers.map((controller) => controller.text).join(','), // Join the options into a single string
                    ));
                  },
                  child: Text(
                    "Add",
